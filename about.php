...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT StudentID FROM tblstudent WHERE UserName=:username and Password=:password";
...
$_SESSION['studencmuid']=$result->ID;
}
