...
$sql="insert into tblstudent(StudFirstname,StudMiddlename,StudLastname,StudentEmail,StudentClass,Gender,DOB,StuID,UserName,Password,Image)values(:fname,:mname,:lname,:stuemail,:stuclass,:gender,:dob,:stuid,:uname,:password,:image)";
...
<html lang="en">
  <head>
    ...
    <title>HardTech|| Add Students</title>
    <!-- plugins:css -->
