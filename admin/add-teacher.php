...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $ret="select UserName from tblteacher where UserName=:uname || TeachID=:teachid";
...
$sql="INSERT INTO tblteacher(Firstname,Middlename,Lastname,TeacherEmail,Gender,TeachID,UserName,Password,Image)values(:Fname,:Mname,:Lname,:teachemail,:gender,:teachid,:uname,:password,:image)";
...
<html lang="en">
  <head>
    ...
    <title>HardTech|| Add Teachers</title>
    <!-- plugins:css -->
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="teachemail" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="teachid" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
