...
$sql="update tblclass set Grade=:grade,Section=:section where ID=:eid";
...
<html lang="en">
  <head>
    ...
    <title>HardTech|| Manage Class</title>
    <!-- plugins:css -->
...
{               ?>  
                      <div class="form-group">
                        ...
                        <input type="text" name="grade" value="<?php echo htmlentities($row->Grade);?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
