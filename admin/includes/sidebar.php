...
{               ?>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#auth1" aria-expanded="false" aria-controls="auth1">
                ...
                <i class="icon-chalkboard menu-icon"></i>
              </a>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth2">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-lesson.php"> Add Lesson</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-lesson.php"> Manage Lessons </a></li>
                </ul>
              </div>
            </li>
            </li>
