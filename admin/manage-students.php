...
<html lang="en">
  <head>
    ...
    <title>HardTech|||Manage Students</title>
    <!-- plugins:css -->
...
$sql="SELECT tblstudent.StuID,tblstudent.StudentID as sid,tblstudent.StudFirstname,tblstudent.StudMiddlename,tblstudent.StudLastname,tblstudent.StudentEmail,tblstudent.DateofAdmission,tblclass.Grade,tblclass.Section from tblstudent join tblclass on tblclass.ID=tblstudent.StudentClass LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td><?php  echo htmlentities($row->StudFirstname);?></td>
                            <td><?php  echo htmlentities($row->StudMiddlename);?></td>
                            <td><?php  echo htmlentities($row->StudLastname);?></td>
