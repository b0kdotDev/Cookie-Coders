...
$sql="delete from tblteacher where TeacherID=:rid";
...
<html lang="en">
  <head>
    ...
    <title>HardTech|||Manage Teacher</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
     ...
     <?php include_once('includes/header.php');?>
      ...
      <div class="container-fluid page-body-wrapper">
       ...
       $ret = "SELECT TeacherID FROM tblteacher";
$query1 = $dbh -> prepare($ret);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$total_rows=$query1->rowCount();
$total_pages = ceil($total_rows / $no_of_records_per_page);
$sql="SELECT tblteacher.TeachID,tblteacher.TeacherID as sid,tblteacher.Firstname,tblteacher.Middlename,tblteacher.Lastname,tblteacher.TeacherEmail from tblteacher  LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
