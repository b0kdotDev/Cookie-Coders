...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT TeachID,TeacherID,TeacherClass FROM tblteacher WHERE (UserName=:teachid || TeachID=:teachid) and Password=:password";
...
$_SESSION['teachid']=$result->TeachID;
$_SESSION['teachecmsuid']=$result->TeacherID;
$_SESSION['teachlass']=$result->TeacherClass;
}
...
<html lang="en">
  <head>
    ...
    <title>HardTech|| Teacher Login Page</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="images/logo.svg"> HardTech
                </div>
